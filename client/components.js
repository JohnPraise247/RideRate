...
import { scrollToAnchor } from './model';
      ...
      m(".background-container"+vnode.state.view,[
        ...
        m(".motto",[ 
              vnode.attrs.nav != "nav-small"?([
                ...
                m(".mt-5",[
                  m("button.btn.btn-primary.btn-fill.m-3[data-aos='zoom-in'][data-aos-delay='500']",{ onclick:()=>{ scrollToAnchor("about")}},"Learn more"/*"Get Started"*/),
